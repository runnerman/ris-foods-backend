...
export default async function handler(
  ...
  try {
    ...
    const {
      ...
      firm_name,              // maps to company_name
      address,                // maps to business_address
      telephone,
      mobile,
      email,
      type,                   // maps to firm_type
      year_of_establishment,
      turnover,               // maps to turnover_last_fy
      warehouse_area,         // maps to warehouse_area_sqft
      comments
    } = req.body;
